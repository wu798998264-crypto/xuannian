...
async function run() {
  ...
  assert(mainSource.includes('recoverMediaPortalVideoAutomation') && mainSource.includes('shouldRetryMediaPortalVideoAutomation'), 'transient first-parse failures must recover within the same user request');
